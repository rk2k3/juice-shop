...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  app.get('/rest/continue-code', security.isAuthorized(), utils.asyncHandler(continueCode()))
  app.get('/rest/continue-code-findIt', security.isAuthorized(), utils.asyncHandler(continueCodeFindIt()))
  app.get('/rest/continue-code-fixIt', security.isAuthorized(), utils.asyncHandler(continueCodeFixIt()))
